...
public class HomeScreen implements Screen, GestureListener, SensorEventListener {
    ...
    private void drawAppIcon(PGraphics g, IApplication app, int centerX, int centerY) {
        ...
        if (icon != null) {
            ...
            // Draw the icon filling the entire tile area (no padding)
            // Icons generated by apps already include their own background/spacing
            g.image(safeIcon, centerX, centerY, ICON_SIZE, ICON_SIZE);
